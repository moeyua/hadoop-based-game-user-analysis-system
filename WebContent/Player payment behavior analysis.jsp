...
ArrayList<String[]> list5 = connDb.f3_1();
//平均每用户收入
ArrayList<String[]> list6 = connDb.f3_2();
//平均每付费用户收入
ArrayList<String[]> list7 = connDb.f3_3();
//各等级付费情况
// 返回值为【等级，总人数，付费人数，付费转化率，付费总金额，人均付费金额，总付费次数，人均付费次数】
ArrayList<String[]> list8 = connDb.f3_4();
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	...
	<aside>
        ...
        <ul>
            ...
            <li  class="li-active">玩家付费行为分析</li>
            <li><a href="./Player game habit analysis.jsp">玩家游戏习惯</a></li>
        </ul>
    </aside>
    <div id="container">
        <div class="top" style="font-size: large;line-height: 60px;text-indent: 20px;">玩家付费行为分析</div>
       ...
       <div class="chart-large" id="3.5"></div>
        <div class="chart-large" id="3.6"></div>
        <div class="chart-large"  id="3.7"></div>
        <div class="chart-large"  id="3.8"></div>
        <div class="chart-large"  id="3.9"></div>
        <div class="chart-large"  id="3.10"></div>
	...
	var line = function (id, title, legend, dimensions, data) {
	   ...
	   <%for(String[] a:list5){%>
		...
		for (var  index = 0; index < data7.length; index++) {
			data7[index] = parseInt(data7[index]);
		}
		data5[0] = parseFloat(data5[0]);
		data5_1 = [data5[0]]
		data5_2 = [data5[1]]
		data6[0] = parseFloat(data6[0])
		data6[1] = parseFloat(data6[1])
		
	bar("3.5","活跃玩家和活跃付费玩家", [""],  ["AU", "APA"], data5)
	
	bar("3.6", "平均每用户收入和平均每付费用户收入", [""],  ["ARPU", "ARPPU"], data6)
	
	line("3.7", "总人数、付费人数与等级的关系", ["总人数", "付费人数"], data7, data8, data9)
	
	line("3.8", "付费转化率", ["付费转化率"], data7, data10)
	
	line("3.9", "人均付费金额", ["人均付费金额"], data7, data11)
	
	line("3.10", "人均付费次数", ["人均付费次数"], data7, data12)
